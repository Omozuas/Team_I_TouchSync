            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 20),
                  CustomTextField(label: 'Phone Contact', hintText: 'Enter phone contact'),
                  const SizedBox(height: 20),
                  CustomTextField(label: 'Social Media Links', hintText: 'Enter social media links'),
                ...
                onPressed: () {
                  ...
                  Navigator.push(context, MaterialPageRoute(builder: (context) => WriteSuccesfulScreen()));
                },
              ),
                ],
              ),
